...
class MarkExtraAttendance extends GetView<ExtraMarkAttendanceController> {
  ...
  void showStudentDetails(ExtraAttendanceList attendanceList) {
    Get.defaultDialog(
      ...
      titleStyle:
      TextStyle(fontFamily: 'mu_bold', fontSize: getSize(Get.context!, 2.5)),
                  ...
                  children: [
                    ...
                    Expanded(
                        child: controller.isLoadingExtraAttendanceList.value
                            ...
                            ? ListView.builder(
                          shrinkWrap: true,
                          itemCount: controller.extraAttendanceDataCopyList.length,
                          itemBuilder: (context, index) {
                            ExtraAttendanceList attendanceList =
                            controller.extraAttendanceDataCopyList[index];
                            return InkWell(
                              onLongPress: () =>
                                          ...
                                          child: Row(
                                            children: [
                                              Padding(
                                                ...
                                                child: InkWell(
                                                  onTap: () {
                                                      if (controller.extraAttendanceDataCopyList[index].count! >0) {
                                                        controller.extraAttendanceDataCopyList[index].count = controller.extraAttendanceDataCopyList[index].count! -1;
                                                      }
                                                      controller.extraAttendanceDataCopyList.refresh();
                                                  },
                                                  child: Container(
                                                    height: getSize(
                                                        Get.context!, 4),
